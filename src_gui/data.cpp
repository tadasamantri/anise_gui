...
/**
 * @brief Data::addNodeToMesh inserts given node into the mesh and renders it
 * afterwards
 * @param newNode
...
int Data::addNode(Node *node) { return addNodeToMesh(node); }
...
/**
 * @brief Data::moveObjectInMesh moves drwan object with given id from start to
 * end
